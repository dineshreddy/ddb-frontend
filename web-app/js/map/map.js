...
$(document).ready(function() {
  ...
  $.extend(DDBMap.prototype, {
      ...
      initLon: 10.00,
      initZoom: 5,
      tileServerUrls: ["//a.tile.ddbmap-t.deutsche-digitale-bibliothek.de/${z}/${x}/${y}.png",
                       "//b.tile.ddbmap-t.deutsche-digitale-bibliothek.de/${z}/${x}/${y}.png",
                       "//c.tile.ddbmap-t.deutsche-digitale-bibliothek.de/${z}/${x}/${y}.png"],
