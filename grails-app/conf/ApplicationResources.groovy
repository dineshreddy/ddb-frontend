...
modules = {
    ...
    javascript {
        ...
        resource url:'/js/vendor/jquery.checkall-1.4/jquery.checkall.js', plugin:'ddb-common'
        ...
        resource url:'/js/search/searchCookie.js', plugin:'ddb-common'
        resource url:'/js/search/urlHelper.js', plugin:'ddb-common'
