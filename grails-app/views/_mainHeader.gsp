...
<div class="cookie-notice visible" id="cookie-notice">
  <div class="container">
    <div class="row">
      <div class="span12">
        <p>
          <g:message code="ddbcommon.Cookie_Acceptance" args="${[createLink(controller: 'content', params: [dir:'datenschutzerklaerung'])]}"/>
        </p>
        ...
        <ul class="nav nav-list" role="navigation" aria-label="Main menu">
          <li><g:form class="navbar-search pull-left"
              ...
              <input type="search" class="query" name="query"
                placeholder="Suche"
                value="<ddbcommon:getCookieFieldValue fieldname="query" aria-label="Search"/>">
              <button type="submit">
            ...
            <div class="search-header hidden-phone">
              <form method="get" role="search" id="form-search-header"
                ...
                <input type="search" id="search-small" class="query" name="query"
                       value="${ddbcommon.getCookieFieldValue(fieldname: "query")}" autocomplete="off" aria-label="Search"/>
                <button type="submit">
                  <!--[if !IE]><!-->
                  <g:message encodeAs="html" code="ddbnext.Go_Button" />
                  <!--<![endif]-->
