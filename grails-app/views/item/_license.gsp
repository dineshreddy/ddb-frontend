...
<g:if test="${license}" >
  <div class="fields">
    <div class="row">
      <div class="span2"><strong><g:message encodeAs="html" code="ddbnext.License_Field" />: </strong><ddb:renderInfoTooltip messageCode="ddbnext.Licence_TooltipContent" controllerAction="lizenzen" hasArrow="true" /></div>
