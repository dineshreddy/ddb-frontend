...
.scroller li .group .thumbnail.audio {
  background:#fff url("../images/icons/audio.png") no-repeat center center;
  background-size:90px auto;
}
.scroller li .group .thumbnail.video {
  background:#fff url("../images/icons/video.png") no-repeat center center;
  background-size:90px auto;
}
.scroller li .group .thumbnail.image {
  background:#fff url("../images/icons/image.png") no-repeat center center;
  background-size:90px auto;
}
