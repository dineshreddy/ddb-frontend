<html>
  <head>
    <title><g:message encodeAs="html" code="error.400.title"/> - <g:message encodeAs="html" code="ddbnext.Deutsche_Digitale_Bibliothek"/></title>
  ...
  <body>
    <div class="errorpage">
      <h1>
        <g:message encodeAs="html" code="error.400.title"/>
      </h1>
      <p>
        <g:message encodeAs="html" code="error.400.body"/>
      </p>
      <hr />
